...
class WEBHOOK_MESSAGES(StrEnum):
    def DEFAULT(msg=''):
        return f'{msg if msg else ""}'
...
class ERROR_MESSAGES(StrEnum):
    ...
    def INVALID_PASSWORD(err=''):
        return err if err else 'The password does not meet the required validation criteria.'
