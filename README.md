...
[![release](https://img.shields.io/static/v1?label=release&message=0.8.12-gpthub.26&color=blue)](https://github.com/IT-AUL/true-tech-hack-2026/releases/latest)
...
[![MTS True Tech Hack 2026](https://img.shields.io/badge/MTS_True_Tech_Hack_2026-🥉_3rd_place-CD7F32?style=flat)](https://truetecharena.ru/contests/true-tech-hack-in2026)
[![Track Winner](https://img.shields.io/badge/Open_WebUI_track-🏆_1st_place-FFD700?style=flat)](https://truetecharena.ru/contests/true-tech-hack-in2026)
...
## Достижения и команда

### Команда **IT-AUL (MISIS × ЦУ × КФУ)**

Проект разработан в рамках хакатона **МТС True Tech Hack 2026** (трек «Форк Open WebUI»).

| Метрика | Значение |
| --- | --- |
| Место в общем зачёте | **3 место** |
| Место в треке «Open WebUI» | **1 место** |
| Призовой фонд хакатона | 1 500 000 ₽ |

Совместная команда студентов **НИТУ МИСИС**, **Центрального Университета** и **Казанского Федерального Университета**.

| Участник | Роль |
| --- | --- |
| **Ранэль** | Капитан, Backend, ML|
| **Данис** | ML, Backend |
| **Ренат** | Frontend, DevOps |
| **Максим** | Дизайнер |
